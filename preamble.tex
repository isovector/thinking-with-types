...
\runsnipcommand{latex-live-snippets code/#1.hs}
...
\runsnipcommand{latex-live-snippets code/#1.hs #2}
...
\runsnipcommand{/usr/bin/bash ghci.sh code/\doreplparam.hs /tmp/\doreplfile.aux \doreplfile}
