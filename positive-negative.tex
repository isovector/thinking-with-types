...
\begin{enumerate}
  ...
  \item{\defnn{Invariant}{invariant}: In general, no function \ty{a -> b} can be
    lifted into a function over \ty{T a}.}
\end{enumerate}
...
and so \ty{(a, Bool) -> Int} is contravariant with respect to \ty{a}.
